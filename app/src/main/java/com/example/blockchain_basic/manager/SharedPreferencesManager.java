...
public class SharedPreferencesManager {
    ...
    private static final String PREFERENCES_DATA="com.example.blockchain_basic.";
    private static final String ENCRYPTION_STATUS="encryption_status";
    private static final String DARK_MODE="dark_theme";
    ...
    public void setDarkMode(boolean isActivated){
        editor.putBoolean(DARK_MODE,isActivated);
        editor.commit();
    }
